# Chapter 7. 웹 앱 아키텍처 & AI 디자인 설계 — 강의 + 실습
...
> **중요**: 프로젝트별 설계 문서 (ARCHITECTURE.md)는 7.4절에서 뼈대를 잡고, 7.8절에서 완성한다.
...
**프로젝트에 설계 문서가 있는 경우** (7.4절에서 작성하는 ARCHITECTURE.md 등):
...
## 7.4 ARCHITECTURE.md — 플랜 문서 뼈대 잡기

설계의 핵심은 **먼저 전체 그림을 그리고, 그 그림대로 실행하는 것**이다. 지금까지 페이지 맵과 유저 플로우로 앱의 구조를 정리했다. 이제 이것을 하나의 문서로 모아 **ARCHITECTURE.md**를 만든다.
...
> **바이브코딩 실습**: Copilot에게 ARCHITECTURE.md 뼈대를 작성하게 한다.
...
### 7.8.2 ARCHITECTURE.md 완성 — 컴포넌트 계층과 데이터 모델 추가
