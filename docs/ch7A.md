...
2. **범용 컨텍스트 파일 3종**(copilot-instructions.md, context.md, todo.md)과 **프로젝트별 설계 파일**(ARCHITECTURE.md)을 구분하여 사용할 수 있다
...
3. **어떤 규칙으로 코딩할지** 준수한다 (copilot-instructions.md — 자동)
4. **(프로젝트별)** 어떤 구조로 만들지 이해한다 (ARCHITECTURE.md — 선택)
...
### 7.7.2 ARCHITECTURE.md — 프로젝트별 설계 문서

앞서 7.2절에서 **모든 프로젝트에 공통으로 사용하는 범용 파일 3종** (copilot-instructions.md, context.md, todo.md)을 배웠다. 
...
|------|------------------|---------------------|
| 예시 | copilot-instructions.md, context.md, todo.md | ARCHITECTURE.md |
| 범위 | 모든 프로젝트 | 이 블로그만 |
